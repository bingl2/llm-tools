...
"뭘 하지?"가 아니라 "이 시간에 이 결과를 낸다"로 하루를 설계하고, 매일 기록하고, 매주 패턴을 발견하고, 그 패턴이 다음 날의 플랜을 더 정확하게 만듭니다. 쓸수록 나에게 맞아가는 시스템입니다.

---

## 핵심 아이디어

**1. 목표는 계층이다** — Foundation(올해의 방향)에서 월간, 주간, 오늘의 Big 3까지 하나의 선으로 연결됩니다.

**2. 하루는 블록이다** — 시간에 결과를 매핑합니다. 결정 피로를 줄이고, Big 3를 먼저 배치합니다.

**3. 기록이 나를 가르친다** — "오전에 집중 잘 됨", "문서 작업은 2배 걸림" 같은 자기 지식이 Foundation에 축적되고, 다음 날의 블록 배치를 더 정확하게 만듭니다.
...
Task는 "했다", Outcome은 **"됐다"**. 끝이 명확해야 끝낼 수 있습니다.
